 ...
 */
extern "C" void oki_encode(int16_t *buffer,uint8_t *outbuffer,long len);
extern "C" void oki6258_encode(int16_t *buffer,uint8_t *outbuffer,long len);
 ...
 * Output buffer should be at least (len*2) elements large.
 */
extern "C" void oki_decode(uint8_t *buffer,int16_t *outbuffer,long len);
extern "C" void oki6258_decode(uint8_t *buffer,int16_t *outbuffer,long len);
